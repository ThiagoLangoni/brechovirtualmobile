package br.fiap.trabalhomobile.ui.login
...
import br.fiap.trabalhomobile.ui.list.ListProdutosActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun goToHome() {
        val intent = Intent(this, ListProdutosActivity::class.java)
